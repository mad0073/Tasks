...
addFit(nruns = 50, n = 100, ngens = 18, startT = 1997, s=-0.025, simCol = "gray40", rescale = TRUE)

#best run so far
smoothScatter(dYear, dAlleles, colramp = Pal, nbin = 100, xlab = "year", ylab = "change in allele freq. since 1998")
addFit(nruns = 50, n = 250, ngens = 18, startT = 1997, s=-0.025, simCol = "gray40", rescale = TRUE)
